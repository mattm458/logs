...
What experiments do we want to do? I think it would be easy to adapt the Wizard of Oz object placement game if we want something interactive.

### What's next

I will continue developing the dialogue engine, and will pick one of the issues above to experiment with (probably the ASR errors and their impact on the neural entrainer).